            ...
            <div className="hidden md:block">
              <div className="flex items-baseline space-x-5 ">
                <div className="cursor-pointer">
                  <h3 className="text-blue-600 font-roboto text-button-m font-medium leading-relaxed">
                    Log In
                  </h3>
                </div>
                <div className="rounded-lg border-2 border-blue-600 bg-blue-600 cursor-pointer">
